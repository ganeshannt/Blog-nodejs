...
export default class RegistrationFrom {
    ...
    passwordAfterDelay() {
        if (this.password.value != "" && this.password.value.length < 5 || this.password.value.length > 15) {
            this.showValidationErrors(this.password, 'Password should contain character between 5 to 15')
        }
    }
